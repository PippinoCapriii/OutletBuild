                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <c:if test="${sessionScope.currentSessionUser.amministratore}">
                                        <a href="${pageContext.request.contextPath}/admin/GestioneCatalogo.jsp">GESTIONE CATALOGO</a>
                                        <a href="${pageContext.request.contextPath}/admin/ViewOrdini.jsp">ORDINI</a>
                                    </c:if>
